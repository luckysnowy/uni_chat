<template>
<view>
		<u-navbar :is-back="true" title="修改用户信息" :background="{ background: '#F6F7F8' }" title-color="#404133" :border-bottom="false" z-index="1001">
			<view class="slot-wrap" slot="right">
				<u-button style="margin-right: 30rpx;" size="mini" type="error" @click="deleteUser()">删除</u-button>
			</view>
		</u-navbar>
		        <view class="row b-b">
				...
				<view class="row b-b">
				    ...
				    <input class="input" type="text" v-model="userInfo.userType" placeholder="请输入用户类型,0:普通用户,1:管理员" placeholder-class="placeholder" />
				</view>
...
<script>
	export default {
		...
		onLoad: function (option) { //option为object类型，会序列化上个页面传递的参数 
				 ...
				 this.userInfo=JSON.parse(option.user)
